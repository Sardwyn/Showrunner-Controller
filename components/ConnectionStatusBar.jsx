...
export default function ConnectionStatusBar({ obsConnected, unrealConnected, ndiConnected = false }) {
    ...
    return (
        <div className="flex items-center text-sm text-white bg-gray-900 px-4 py-2 border-b border-gray-700">
            ...
            <div className="flex items-center gap-2">
                <StudioButton label="OBS" full={false} color="gray" isActive={obsConnected} />
                <StudioButton label="Unreal" full={false} color="gray" isActive={unrealConnected} />
                <StudioButton label="NDI" full={false} color="gray" isActive={ndiConnected} />
                <StudioButton
                    label="Emergency Cut"
                    full={false}
                    color="red"
            ...
            <div className="flex items-center gap-2">
                <button onClick={startCounter} className="pro-button bg-green-600">▶</button>
                <button onClick={pauseCounter} className="pro-button bg-yellow-500">⏸</button>
                <button onClick={resetCounter} className="pro-button bg-red-600">⏹</button>
